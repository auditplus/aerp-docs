...
sidebar_position: 10
---
Section means a group/category under which related products are organized. In inventory management, a Section is a higher-level classification used to divide inventory into major groups or areas.
It helps organize a large inventory before breaking it down into categories and subcategories.
