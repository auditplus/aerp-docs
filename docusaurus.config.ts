...
const config: Config = {
  title: 'Auditplus',
  tagline: 'The Complete ERP Solution',
  ...
  future: {
    ...
    // Stable configuration layout for Docusaurus 3.10.x
    faster: {
      // 🛑 Turn off the persistent file cache to stop the ModuleGraph panic
      rspackPersistentCache: false, 
  
      // ✅ You can safely leave the rest on for quick build speeds:
      rspackBundler: true,
      swcJsLoader: true,
      swcJsMinimizer: true,
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/auditplus',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Auditplus Technologies, Tuticorin.`,
    },
    prism: {
